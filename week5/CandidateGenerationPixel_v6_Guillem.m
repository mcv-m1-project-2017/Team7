...
directory='/home/mcv07/Team7/week4/validation_images';
...
directory_results = '/home/mcv07/Team7/week5/results'

method=4; %Int value: 1 if want to aply method 1
...
%Hough transform
    if HG
            [BoundingBoxes] = Hough_Segment(im,im_seg);
            [windowCandidates] = windowCand_v2(im_seg,w, h, ff, fr, BoundingBoxes,windMethod);
    end
